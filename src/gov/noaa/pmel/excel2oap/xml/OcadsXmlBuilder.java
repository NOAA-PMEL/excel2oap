...
public class OcadsXmlBuilder extends XmlBuilderBase implements XmlBuilder  {
    ...
    private void addMiscInfo(SDIMetadata sdi, NonNullHashMap<String, String> generalFields) {
...
//                .datasetDoi(generalFields.get(nothing))
    ...
    private void addCoverage(SDIMetadata sdi, NonNullHashMap<String, String> generalFields) {
